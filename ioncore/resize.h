...
extern WMoveresMode *region_begin_resize(WRegion *reg, WDrawRubberbandFn *rubfn, bool cumulative);
extern WMoveresMode *region_begin_move(WRegion *reg, WDrawRubberbandFn *rubfn, bool cumulative);
extern void moveresmode_delta_resize(WMoveresMode *mode, int dx1, int dx2, int dy1, int dy2, WRectangle *rret);
extern void moveresmode_delta_move(WMoveresMode *mode, int dx, int dy, WRectangle *rret);
extern void moveresmode_rqgeom(WMoveresMode *mode, WRQGeomParams *rq, WRectangle *rret);
...
DYNFUN void region_managed_rqgeom(WRegion *reg, WRegion *sub, const WRQGeomParams *rqgp, WRectangle *geomret);
DYNFUN void region_managed_rqgeom_absolute(WRegion *reg, WRegion *sub, const WRQGeomParams *rqgp, WRectangle *geomret);
extern void region_rqgeom(WRegion *reg, const WRQGeomParams *rqgp, WRectangle *geomret);
extern void region_managed_rqgeom_unallow(WRegion *reg, WRegion *sub, const WRQGeomParams *rq, WRectangle *geomret);
extern void region_managed_rqgeom_allow(WRegion *reg, WRegion *sub, const WRQGeomParams *rq, WRectangle *geomret);
extern void region_managed_rqgeom_absolute_default(WRegion *reg, WRegion *sub, const WRQGeomParams *rq, WRectangle *geomret);
...
extern void region_size_hints_correct(WRegion *reg, int *wp, int *hp, bool min);
...
extern void region_absolute_geom_to_parent(WRegion *reg, const WRectangle *rgeom, WRectangle *pgeom);
extern void rqgeomparams_from_table(WRQGeomParams *rq, const WRectangle *origg, ExtlTab g);
