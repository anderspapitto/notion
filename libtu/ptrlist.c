...
bool ptrlist_reinsert_last(PtrList **ptrlist, void *ptr) {
  ...
  if (node == NULL) return ptrlist_insert_last(ptrlist, ptr);
...
bool ptrlist_reinsert_first(PtrList **ptrlist, void *ptr) {
  ...
  if (node == NULL) return ptrlist_insert_first(ptrlist, ptr);
...
bool ptrlist_remove(PtrList **ptrlist, void *ptr) {
  ...
  if (node != NULL) free_node(ptrlist, node);

  return (node != NULL);
}

void ptrlist_clear(PtrList **ptrlist) {
  while (*ptrlist != NULL) free_node(ptrlist, *ptrlist);
}
