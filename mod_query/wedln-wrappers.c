 ...
 */
EXTL_EXPORT_MEMBER
void wedln_back(WEdln *wedln) { edln_back(&(wedln->edln)); }

/*EXTL_DOC
 * Move forward one character.
 */
EXTL_EXPORT_MEMBER
void wedln_forward(WEdln *wedln) { edln_forward(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_bol(WEdln *wedln) { edln_bol(&(wedln->edln)); }

/*EXTL_DOC
 * Go to the end of line.
 */
EXTL_EXPORT_MEMBER
void wedln_eol(WEdln *wedln) { edln_eol(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_skip_word(WEdln *wedln) { edln_skip_word(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_bskip_word(WEdln *wedln) { edln_bskip_word(&(wedln->edln)); }

/*EXTL_DOC
 * Delete current character.
 */
EXTL_EXPORT_MEMBER
void wedln_delete(WEdln *wedln) { edln_delete(&(wedln->edln)); }

/*EXTL_DOC
 * Delete previous character.
 */
EXTL_EXPORT_MEMBER
void wedln_backspace(WEdln *wedln) { edln_backspace(&(wedln->edln)); }

/*EXTL_DOC
 * Delete all characters from current to end of line.
 */
EXTL_EXPORT_MEMBER
void wedln_kill_to_eol(WEdln *wedln) { edln_kill_to_eol(&(wedln->edln)); }

/*EXTL_DOC
 * Delete all characters from previous to beginning of line.
 */
EXTL_EXPORT_MEMBER
void wedln_kill_to_bol(WEdln *wedln) { edln_kill_to_bol(&(wedln->edln)); }

/*EXTL_DOC
 * Delete the whole line.
 */
EXTL_EXPORT_MEMBER
void wedln_kill_line(WEdln *wedln) { edln_kill_line(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_kill_word(WEdln *wedln) { edln_kill_word(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_bkill_word(WEdln *wedln) { edln_bkill_word(&(wedln->edln)); }

/*EXTL_DOC
 * Set \emph{mark} to current cursor position.
 */
EXTL_EXPORT_MEMBER
void wedln_set_mark(WEdln *wedln) { edln_set_mark(&(wedln->edln)); }

/*EXTL_DOC
 * Clear \emph{mark}.
 */
EXTL_EXPORT_MEMBER
void wedln_clear_mark(WEdln *wedln) { edln_clear_mark(&(wedln->edln)); }
 ...
 */
EXTL_EXPORT_MEMBER
void wedln_cut(WEdln *wedln) { edln_cut(&(wedln->edln)); }

/*EXTL_DOC
 * Copy text between \emph{mark} and current cursor position to clipboard.
 */
EXTL_EXPORT_MEMBER
void wedln_copy(WEdln *wedln) { edln_copy(&(wedln->edln)); }
...
EXTL_SAFE
EXTL_EXPORT_MEMBER
const char *wedln_contents(WEdln *wedln) { return wedln->edln.p; }
...
EXTL_SAFE
EXTL_EXPORT_MEMBER
int wedln_point(WEdln *wedln) { return wedln->edln.point; }
...
EXTL_SAFE
EXTL_EXPORT_MEMBER
int wedln_mark(WEdln *wedln) { return wedln->edln.mark; }
...
EXTL_SAFE
EXTL_EXPORT_MEMBER
const char *wedln_context(WEdln *wedln) { return wedln->edln.context; }
