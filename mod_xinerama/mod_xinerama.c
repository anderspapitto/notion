...
bool mod_xinerama_init() {
  xinerama_ready = XineramaQueryExtension(ioncore_g.dpy, &xinerama_event_base,
                                          &xinerama_error_base);
  if (!xinerama_ready)
...
void mod_xinerama_deinit() { mod_xinerama_unregister_exports(); }
/* }}} */
